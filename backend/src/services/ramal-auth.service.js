...
const refreshRepo = require('../repositories/ramal-refresh-tokens.repository');
...
async function issueTokens(user, meta = {}) {
  const payload = ramalPayload(user);
...
async function createUsuario({ username, nome, senha, perfil }) {
...
async function updateUsuario(id, { username, nome, perfil, ativo }) {
